...
echo "     docker tag producer-app:latest <your-acr-name>.azurecr.io/producer-app:latest"
echo "     docker tag consumer-app:latest <your-acr-name>.azurecr.io/consumer-app:latest"
echo "  2. Push images to ACR:"
echo "     docker push <your-acr-name>.azurecr.io/producer-app:latest"
echo "     docker push <your-acr-name>.azurecr.io/consumer-app:latest"
