...
echo "       https://kong-mtls.jim00.pd.test-rig.nl/consumer/api/consume"
echo ""
echo "Note:"
echo "  ${OUTPUT_DIR}/ca.crt is for client-certificate chain verification only."
echo "  Do not pass it as --cacert unless your Kong TLS cert is signed by that CA."
echo ""
